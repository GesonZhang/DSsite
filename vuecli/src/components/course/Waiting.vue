<template>
    <div class="course">
        <router-link to="/"><input type="button" value="请登录" class="btn"></router-link>
        <p>您还未登录，请登录后查看</p>
                ...
                <div class="course-content">
                    <div class="course-headpic">
                        ...
                        <div class="course-title">
                            {{info.c_subject}}
                            <img v-if="identify==0" class="img-circle" src="../../assets/img/test.png"
                                 alt="">
    ...
    export default {
        ...
        mounted() {
            Axios.get('http://localhost:3000/courseList_teacher', {
                ...
                this.$store.dispatch('sentlength0', this.classtea_list.length);
            })
        }
    }
</script>
